...
export const rawFreqTiersSTRINGS = {
    0: ["😂❤️"],
    1: ["😍🤣"],
    2: ["😊🙏💕😭😘"],
    3: ["👍😅👏😁♥️🔥💔💖💙😢🤔😆🙄💪😉☺️👌🤗"],
    ...
    11: [
        "👷🛍️🏎️🔛🔙🗼🎖️🚺🐹🥖🇵🇷🎡🔍🏟️🖥️🌭🇹🇭✡️🏒🛀📅🖋️🇸🇪🎞️🎪🍙🛁📕👒🖇️❔🎄🕸️🥜🕴️🥟↙️◾🐲🏴🦌🆔👛�↪️🇬🇷�,🌫️🌂🕉️🆚📉🗨️🛒📛🇳🇱🐿️🅾️☢️🇲🇦🐃⛽🅿️🦇⤴️⛵👞🔓🧞⛰️📎🦎🔌🏳️🚽🍲⚒️♊👢🧙🇵🇱⛪🇧🇪🎎🔖🔋📡🌇🏉👪👖📊🐆🔁🛩️🐡🃏👩‍💻🌩️🇳🇬🐏6️⃣⛹️🗯️🇨🇭🍢🗺️🚕🇷🇺Ⓜ️⛱️🏫📀🆙🤼🐨🦂💷🥈👨‍💻🛏️◼️🚄🧖🎠🐁🗳️🏮🥪🌥️🚪㊙️🗞️👨‍⚕️🖊️⬛🆒🇨🇺🥧👩‍⚕️🇳🇮👨‍🎓🚧⛓️🛵🥅🚅🖼️♿📏🀄🖌️🉐📬🚁🗑️🤵🏷️🌡️🎐🇯🇲🦒🎒🇵🇾🇺🇦🇲🇨🥉7️⃣⌛🌒🥥🎅🧕🛐♋🧑🇩🇴🇮🇪🛸🧒📧🥢🎢🐪🇮🇱👨‍🍳🚛🥄🤹🏢💈👘🇳🇴🇬🇭🏔️〽️🚦🇿🇦🇹🇳💼♈🦓🚻🎰◽🦗🤾👚👡⛏️9️⃣🛎️🐗🌦️🇸🇦🚹🇾🇪☪️🤺🚣🗿🥘🇩🇰🦕🇱🇷🏕️☣️🌆↕️📨🏨🕹️👩‍🍳🇨🇮",
    ],
    12: [
        "📯👜🏘️🐫⛺👩‍🏫🕳️🏯🌓🌉8️⃣💂🔉👨‍👩‍👧‍👦🇪🇺🚜🔕📥🌔🏙️🥨🇲🇾📗📜♏🇧🇴🏜️🍘🛬🌯🏗️🏴󠁧󠁢󠁥󠁮󠁧󠁿🚼🏞️🔈🕰️🏓🇨🇷👨‍🌾🦃🔦🔃🇸🇻🛳️🌘🇧🇩🧛👩‍❤️‍👩🔚🔟ℹ️🛢️🏴󠁧󠁢󠁳󠁣󠁴󠁿🇸🇩🔭🇮🇶🎍🥣🌗↖️🎳👨‍❤️‍💋‍👨👨‍🏫📄🇶🇦👨‍👩‍👧🎚️🛠️🆓🇵🇸🏛️♐🧦🗾👩‍🌾🎑🇬🇹🧤🧝➿🇻🇳📒♉♓🚭🔧♌↩️♒🏦🈵🥫🌖🛴🚖🥙🛰️🦏🇸🇬⏺️🖍️⛸️📙👲🏂*️⃣🔲🇭🇺🚐👨‍❤️‍👨🔇🦔🔯🚵🚯🕛📼🧓🎛️🇨🇿🇭🇰💺👩‍🎤⛲⚛️🕒📶🚋🇱🇧📠🚇⏲️⏪🇰🇼🛃🇭🇳👨‍✈️📓👩‍👧♎🏑📋🔼🇨🇵🇯🇴📃🔬🇫🇮🚥🇱🇰♍🇵🇦🇸🇾🚾🇭🇷🇳🇿🚍🏸🔳🛂📵⛑️🏚️🎽🚰🏪⛷️👩‍💼♑🇨🇲🇱🇾⏫🏣🚉🛅⚕️⛴️👁️‍🗨️🏧◻️👩‍🔬⏹️🇷🇴👩‍👦⬜",
    ],
    13: [
        "#️⃣🇦🇱🇹🇼🛣️🏤🛄🇮🇸🏬👨‍🎤🕐🎦👨‍💼💹☸️📴📐🖱️🇭🇹🇸🇳🔩🈲🎴📳☦️🚆📁📔🇦🇫👩‍🎨🕑🚸🧣👨‍🚀🇧🇭🏭🏺🇬🇳🤽🛥️🇲🇱🌁🤶🇦🇿💽🇦🇴🚎🇮🇷🇳🇵🗒️🇨🇩🛋️⌨️🆎🧗🧥🇰🇪🛶📑👝🇦🇲⏯️🇬🇪💱👨‍🎨🇧🇬🇪🇦👩‍⚖️🕓👩‍🚀🚞👨‍🚒🆖🔀👨‍🔬👨‍⚖️👨‍👩‍👦‍👦🏴󠁧󠁢󠁷󠁬󠁳󠁿🥠🚳🇧🇯🇲🇬🇪🇪⏭️🕎🈚🚡🕕🇷🇸🉑📂🇹🇿📫🕘🚊🚈🔂➗🕗👨‍👩‍👧‍👧🈹🇱🇺🛤️🇺🇬🕖🈴👨‍🔧🔏🇧🇼🚷🇲🇰🇱🇻🕙🇹🇹🇱🇹👩‍❤️‍💋‍👨👨‍👧📟👩‍✈️⏸️👩‍🚒🇿🇼🥡🇸🇰🕔",
    ],
    14: [
        "🇴🇲💾📤⚗️🔠🚝🆑🇲🇲👨‍👦🇲🇹🕚🇧🇦👩‍👧‍👦🎿🔤🈶🚱🚏🇳🇪👩‍🔧🇧🇸🕍🇰🇭🔢🇨🇾📭📪🈳🇲🇷👩‍❤️‍👨👩‍👩‍👧🇰🇿🖨️⏮️🇬🇾🇸🇮🇧🇾🇸🇴🕠🇦🇼🖲️⚱️🇲🇪🇿🇲🇧🇧🇹🇯🇨🇬🇺🇿🇸🇱🇳🇦🚟🇧🇮🇽🇰🇦🇮🇪🇹👩‍👩‍👧‍👧🇦🇬👨‍🏭👩‍👧‍👧👨‍👨‍👧‍👧🈯🚠🕟👨‍👨‍👦‍👦👩‍👩‍👧‍👦🇷🇼🇦🇽👩‍👦‍👦🇫🇯🥌🇦🇸🇹🇩👨‍👧‍👦🇦🇩🇬🇲🇬🇦🗂️🇧🇲👩‍🏭",
    ],
